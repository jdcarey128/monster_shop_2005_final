...
#item_orders
item_order_1 = ItemOrder.create!(order_id: order_1.id, item_id: pull_toy.id, order_price: pull_toy.price, quantity: 5)
item_order_2 = ItemOrder.create!(order_id: order_2.id, item_id: brakes.id, order_price: brakes.price, quantity: 4)
item_order_3 = ItemOrder.create!(order_id: order_3.id, item_id: tire.id, order_price: tire.price, quantity: 3)
item_order_4 = ItemOrder.create!(order_id: order_4.id, item_id: rope_ball.id, order_price: pull_toy.price, quantity: 10)
item_order_5 = ItemOrder.create!(order_id: order_5.id, item_id: tennis_balls.id, order_price: pull_toy.price, quantity: 16)
item_order_6 = ItemOrder.create!(order_id: order_5.id, item_id: bagel.id, order_price: bagel.price, quantity: 6)
item_order_7 = ItemOrder.create!(order_id: order_1.id, item_id: steamer.id, order_price: steamer.price, quantity: 8)
item_order_8 = ItemOrder.create!(order_id: order_3.id, item_id: helmet.id, order_price: helmet.price, quantity: 7)
item_order_9 = ItemOrder.create!(order_id: order_4.id, item_id: frisbee.id, order_price: frisbee.price, quantity: 20)
item_order_10 = ItemOrder.create!(order_id: order_1.id, item_id: frame.id, order_price: frame.price, quantity: 2)
item_order_11 = ItemOrder.create!(order_id: order_2.id, item_id: dog_bone.id, order_price: dog_bone.price, quantity: 14)
